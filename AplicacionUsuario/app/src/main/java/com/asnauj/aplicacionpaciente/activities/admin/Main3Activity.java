...
import com.asnauj.aplicacionpaciente.activities.doctor.InfoPacienteDocActivity;
...
public class Main3Activity extends AppCompatActivity {
    ...
    @BindView(R.id.admin_buscar)
    Button buscar;
    @BindView(R.id.admin_aBuscar)
    TextView user;
    @Override
            ...
            try{
                ...
                if(line.equals("CONEXION")){
                    ...
                    if(line.equals("USUARIO")){
                        ...
                        out.println("USUARIOADMIN:" + usuario);
                        line = in.readLine();
                        if(line.startsWith("OK")){
                            ...
                            intn.putExtra("FACTURAS", facturas);
                            startActivity(intn);
                            finish();
